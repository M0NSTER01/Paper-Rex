            ...
            <main className="flex-1 w-full flex flex-col items-center">
                ...
                <section className="w-full max-w-4xl mx-auto px-6 py-32 flex flex-col items-center text-center space-y-12 relative" id="about">
                    ...
                    <div className="flex gap-6 pt-8 border-t border-surface-variant w-32 justify-center">
                        <a className="text-on-surface hover:text-primary transition-colors" href={data?.contact?.linkedin ? (data.contact.linkedin.startsWith("http") ? data.contact.linkedin : "https://" + data.contact.linkedin) : "#"} target="_blank" rel="noopener noreferrer"><span className="material-symbols-outlined text-2xl">link</span></a>
                        <a className="text-on-surface hover:text-primary transition-colors" href={data?.contact?.github ? (data.contact.github.startsWith("http") ? data.contact.github : "https://" + data.contact.github) : "#"} target="_blank" rel="noopener noreferrer"><span className="material-symbols-outlined text-2xl">code</span></a>
